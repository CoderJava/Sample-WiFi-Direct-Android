...
public class TransferModelGenerator {
    ...
    public static ITransferable generateChatImageTransferModel(ChatDTO chat) {
        // Chat are type response and with image
        TransferModel transferModel = new TransferModel(TransferConstants.CHAT_DATA_IMAGE,
                TransferConstants.TYPE_RESPONSE,
                chat.toString());
        return transferModel;
    }
